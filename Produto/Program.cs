...
while (loop)
{
    ...
    switch (opcao)
    {
        ...
        case 1:
            ...
            produto1.SetDescricao(Console.ReadLine());
            Console.WriteLine("Digite a Unidade do produto (LT, CX, KG, UN, MT) : ");
            produto1.SetUnidade(Console.ReadLine());
            Console.WriteLine("Digite o preço do produto R$: ");
            produto1.SetPreco(Convert.ToDouble(Console.ReadLine()));
            Console.WriteLine("Digite a quantidade disponivel em estoque");
            produto1.SetQtdEstoque(Convert.ToInt32(Console.ReadLine()));
